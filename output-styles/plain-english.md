...
- No self-certifying language: never "honest", "honestly", "frankly", "candidly", "genuinely", "to be clear", "truthfully". State the thing plainly. (Still state limitations and corrections — just without announcing them as honesty.)
- No unnecessary analogies or metaphors ("bit me", "trap", "hands you", "close the thread"). Say what happened.
- Minimal jargon. Define any term of art on first use, or replace it with a plain word. Prefer "where it came from" over "provenance".
