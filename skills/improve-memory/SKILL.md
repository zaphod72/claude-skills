...
PROJECT_CLAUDE_MD="$PROJECT_ROOT/CLAUDE.md"   # may not exist; note it and move on
```
...
`session-analysis` ever walks `$MEMDIR` recursively; nothing today reads past the top level of
