...
- **Status stays honest.** Plan status vocabulary is local to each plan and unreliable — `DONE` often means "written, unpushed". Say what you read it as, and let the user correct you.
