...
diff (`SKILL.md`'s `is_never_trivial()`). Baseline it first: `claims-and-scope-discipline` §11 and
...
instead of one: does the suite stay green, and does it **stop catching what it used to catch**?
