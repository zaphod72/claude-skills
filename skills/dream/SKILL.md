...
# project's slug, under $TMPDIR (falling back to /tmp) — the identical formula used for
...
## 6. Read session-analysis's output at its project-scoped path — and the collision risk that remains
...
## 11. Report honestly, same standard send-results itself uses
