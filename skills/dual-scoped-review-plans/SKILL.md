...
| **Synthesiser** | Both passes, and the run | Must have watched the run, not merely dispatched |
...
into the other agent's brief, or into a later message, without ever intending to; it cannot
